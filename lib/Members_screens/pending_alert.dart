...
import '../Admin_screens/Models/deposit_model.dart';
...
class _PendingAlertScreenState extends State<PendingAlertScreen> {
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    ...
                                                    style: TextStyle(
                                                        color: Color(0xFF959595), fontSize: 10),
                                                  ),
                                                ],
                                              ),
                                            ),
  ...
  Future getMembers() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      setState(() {
        data = MemberData.fromMap(snapshot.docs.first.data() as Map<String, dynamic>);
        isLoadnig = false;
      });
    }
  }
