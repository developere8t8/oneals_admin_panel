...
import 'package:oneal_admin_panel/Admin_screens/Models/deposit_model.dart';
import 'package:oneal_admin_panel/Admin_screens/Models/members.dart';
import 'package:intl/intl.dart';
import 'package:http/http.dart' as http;
import 'package:oneal_admin_panel/Admin_screens/newrecord/credit_screen2.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "Total",
                                  style: TextStyle(
                                      color: Color(0xFFFFFFFF).withOpacity(0.74),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(right: 30.0, bottom: 6),
                                      child: Image.asset(
                                        'images/tick.png',
                                        height: 60,
                                        width: 60,
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "Pending Approval",
                                style: TextStyle(
                                    color: Color(0xFF333D41), fontWeight: FontWeight.bold, fontSize: 16),
                              ),
                              Row(
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            ...
                                                            style: TextStyle(
                                                                color: Color.fromRGBO(142, 55, 42, 1),
                                                                fontWeight: FontWeight.bold,
                                                                fontSize: 18),
                                                          ),
                                                        ],
                                                        ...
                                                        children: [
                                                          MaterialButton(
                                                            onPressed: () async {
                                                              ...
                                                              await deposit.delete().whenComplete(() =>
                                                                  sendPushMessage(
                                                                      'Information',
                                                                      'Your deposit ₦${mydata[i].get('Deposit Amount')} for ${mydata[i].get('Payment Category')} payment hass been rejected',
                                                                      memData.token!));
                                                              Navigator.pop(context);
                                                              showDialog(
                                                                context: context,
                                                          ...
                                                          MaterialButton(
                                                            onPressed: () async {
                                                              double paynow =
                                                                  mydata[i].get('Deposit Amount');
                                                              String name = mydata[i].get('ParentName');
                              ...
                              onPressed: () async {
                                for (int i = 0; i < mydata.length; i++) {
                                  ...
                                  QuerySnapshot snap = await FirebaseFirestore.instance
                                      .collection('Members')
                                      .where('Added', isEqualTo: mydata[i].get('Added'))
                                      .get();
                                  if (snap.docs.isNotEmpty) {
                                    MemberData memdata = MemberData.fromMap(
                                        snap.docs.first.data() as Map<String, dynamic>);
                                    double earningBalance = memdata.earmingBalance!;
                                    double Newbalance = earningBalance < 0
                                        ? earningBalance + mydata[i].get('Deposit Amount')
                                        : earningBalance - mydata[i].get('Deposit Amount');
                                    final balanceUpdate = FirebaseFirestore.instance
                                        .collection('Members')
                                        .doc(memdata.added);
                                    await balanceUpdate.update({
                                      'earning_balance': Newbalance
                                        ...
                                        'Information',
                                        'Your deposit ₦${mydata[i].get('Deposit Amount')} for ${mydata[i].get('Payment Category')} payment hass been approved',
                                        memdata.token!));
                                  }
                                }
                                showDialog(
