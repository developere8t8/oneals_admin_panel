...
class MemberChatHomeScreen extends StatefulWidget {
  MemberChatHomeScreen({required this.name, required this.compId, required this.docid});
...
class _MemberChatHomeScreenState extends State<MemberChatHomeScreen> with WidgetsBindingObserver {
