                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        Map<String, dynamic> map =
                            snapshot.data!.docs.reversed.toList()[index].data() as Map<String, dynamic>;
  ...
  Widget messages(Size size, Map<String, dynamic> map, BuildContext context) {
    return map['type'] == 'text'
        ? Container(
            ...
            alignment: map['sendby'] == widget.docId ? Alignment.centerRight : Alignment.centerLeft,
            child: Container(
              padding: EdgeInsets.symmetric(vertical: 10, horizontal: 14),
              margin: EdgeInsets.symmetric(vertical: 5, horizontal: 8),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15),
                  color: map['sendby'] == widget.docId ? Color(0xFF83050C) : Colors.black38),
              child: Text(
                map['message'],
                style: TextStyle(
                  fontSize: 16,
